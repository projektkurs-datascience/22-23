...
Welche Art von Multiplikation führt der R Befehl `x*x` durch?'
...
b) `P` Lesen Sie nun den Datensatz eu_macro_2017.csv ein uns speichern Sie diesen unter `dat`. Der Datensatz hat eine Kopfzeile, Datenpunkte werden mit Kommas voneinander getrennt und Dezimalstellen mit Punkten gekennzeichnet und befindet sich im Ordner "data". Nutzen Sie `read_csv` für das Einlesen.
