...
stargazer(reg_dep6m, reg_dep6m_long, reg_dep1y, reg_dep1y_long, reg_dep7y, reg_dep7y_long, 
          type = "html",
          covariate.labels = c("Treatment"),
          keep = "treat",
          dep.var.caption  = "Depressionen",
          add.lines = list(c("Kontrollvariablen", "Nein", "Ja", "Nein", "Ja", "Nein", "Ja")),
          dep.var.labels   = c("Nach 6 Monaten", "Nach 1 Jahr", "Nach 7 Jahren"),
...
.pull-right[
```{r, echo=F, results='asis'}
stargazer(reg_dep6m, reg_dep1y, reg_dep7y, type = "html",
          covariate.labels = c("Treatment"),
          keep = "treat",
          dep.var.caption  = "Depressionen",
          add.lines = list(c("Kontrollvariablen", "Nein", "Nein", "Nein")),
          dep.var.labels   = c("Nach 6 Monaten", "Nach 1 Jahr", "Nach 7 Jahren"),
          title = "Depression bei Müttern ohne Kontrollvariablen")
```
