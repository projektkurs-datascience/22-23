...
- Auf Moodle gibt es ein Diskussionforum, scheuen Sie sich nicht dort ihre Fragen zu stellen!
    ...
    - Wir haben einige Beispiele aufgearbeitet, wie Sie Fragen stellen sollten, damit Sie schnell eine antworten erhalten. Das Dokument finden Sie in Moodle unter `Wie stelle ich Fragen im Forum?`
--
...
Der **erste Tutoriumstermin** ist am **20.10.2022** von **14 - 18 Uhr** ( **online** )
...
Die **erste Übung** ist am **21.10.2022** von **10:15 - 11:45 Uhr** ( in **H3** ) 
...
.instructions[Es ist sehr wichtig, dass jeder die neueste Version von R (Version 4.2.1) und RStudio (Version 2022.07.2-576) installiert hat und sein Konto über git versioniert da die späteren Projekte hierrüber laufen.]
...
## Projekt 2: Standortwahl von Pflegeheimen um Ulm
...
.alert[Wie sieht die Altersstruktur in Ulm und um Ulm aus? Wo wäre ein geeigneter Standort für ein Alten- und Pflegeheim?]

Zur Beantwortung dieser Frage Werten Sie Industriedaten aus, die uns von der [Exaris Solutions](https://exaris-solutions.de/) zur Verfügung gestellt wurden. 

**Besonderheit in diesem Projekt:** Am 05.12.2022 gibt es einen Workshop mit dem Geschäftsführer von Exaris Solutions, der mit ihnen tiefergehende Analysen durchführen wird.
]
.pull-right[
<br><br>
```{r, echo=FALSE, out.width="100%"}
seniorenheim <- "figs/seniorenheim_bad-waldsee.jpg"
include_graphics(seniorenheim)
```

<font size="1">Quelle: https://www.st-elisabeth-stiftung.de/wohnen-und-pflege/wohnangebote-fuer-senioren/wohnpark-st-franziskus</font> 
]

---

## Projekt 3: Die Inflation in Deutschland, dem Euroraum und den USA
...
.alert[Was sind die Treiber der Inflation in unterschiedlichen Ländern und welche Rolle spielen Zentralbanken für die Geldwertstabilität?]

In diesem Projekt beantworten Sie folgende Fragen:

- Wie wird Inflation gemessen?
- Was sind die Unterschiede in den einzelnen Ländern in der Inflation(smessung)?
- Was können Zentralbanken für die Geldwertstabilität tun?
]
.pull-right[
<br><br>
```{r, echo = FALSE, out.width="100%"}
ezb <- "figs/ezb.jpg"
include_graphics(ezb)
```

<font size="1">Quelle: https://www.tagesschau.de/wirtschaft/finanzen/ezb-inflation-geldpolitik-strategie-101.html</font> 
]
...
- Laden Sie R und RStudio herunter
    ...
    - _Bitte beachten Sie_: 
        - Installieren Sie die neueste Version von R (4.2.1) und R-Studio (2022.07.2)
...
- Für jedes Projekt werden neue Gruppe gebildet
